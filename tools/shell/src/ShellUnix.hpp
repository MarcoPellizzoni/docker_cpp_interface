...
//        auto pPipe = ::popen(command.c_str(), "r");
//        if(pPipe == nullptr)
//        {
...
public:
	...
	void execute()
	{
		try
		{
			...
			if (WIFEXITED(inspect_status))
			{
				ExitStatus = WEXITSTATUS(inspect_status);
			}
